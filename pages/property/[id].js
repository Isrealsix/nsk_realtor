    ...
    <Box
      ...
      <Box w="full" p="6">
        <Flex paddingTop="2" alignItems="center" justifyContent="space-between">
          ...
          <Text fontWeight="bold" fontSize="lg">RUB {millify(price)}{rentFrequency && `/${rentFrequency}`}</Text>
        </Flex>
        <Box>
        ...
        <Box>
          {amenities.length && <Text fontSize="2xl"
            fontWeight="black" marginTop="5">Amenities</Text>}
          <Flex flexWrap="wrap">
            {amenities.map(item => (
